      ...
      <main className="min-h-screen">
        ...
        <div className="mx-auto max-w-lg px-5 py-20 text-center">
          ...
          <h1 className="mt-3 font-mono text-xl font-bold text-paper">
            Upload your offer first
          </h1>
          <p className="mt-2 text-sm text-slate">
            The batch-wide directory unlocks the moment you add your offer —
            no waiting on approval.
          </p>
          <a
            href="/dashboard"
            className="mt-6 inline-block rounded-full bg-amber px-5 py-3 font-semibold text-ink hover:bg-amber/90"
          >
            Go to dashboard
          </a>
        </div>
              ...
              >
                <div className="flex items-start justify-between gap-2">
                  ...
                  <span
                    ...
                    style={{
                      color: cityBySlug(r.city)?.color,
                      backgroundColor: `${cityBySlug(r.city)?.color}1a`,
                    }}
                  >
                    {cityBySlug(r.city)?.code ?? r.city}
                  </span>
                </div>
