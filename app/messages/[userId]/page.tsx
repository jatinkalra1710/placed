...
export default function ThreadPage({
  ...
  useEffect(() => {
    async function load() {
      ...
      // mark any incoming unread messages in this thread as read
      await supabase
        .from("messages")
      ...
      <section className="mx-auto flex w-full max-w-2xl flex-1 flex-col px-5 py-8">
          ...
          {messages.map((m, i) => {
            ...
            return (
              ...
              >
                ...
                <span className="mt-0.5 px-1 font-mono text-[10px] text-slate">
        ...
        <form onSubmit={send} className="mt-4 flex gap-2">
          ...
          <button
            ...
            className="rounded-full bg-amber px-4 py-2.5 text-sm font-semibold text-ink hover:bg-amber/90 disabled:opacity-50"
          >
            Send
          </button>
        </form>
