  ...
  async function signInWithGoogle() {
    ...
    const { error: oauthError } = await supabase.auth.signInWithOAuth({
      ...
      options: {
        ...
        // No "hd" hint here on purpose — it locks Google's login screen to
        // only accept @thapar.edu, which blocks test Gmail accounts from
        // even being typed in. The database trigger is the real gate, so
        // this UI hint isn't needed for security, only convenience — and
        // it gets in the way of testing, so it's left off.
        queryParams: {
